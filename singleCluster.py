...
#                print('dividing')
                ...
                bug = Ecoli([x,y],b.pheno,b.radius,b.mass,orig=b.orig)
                self.bugList.append(bug)
...
runDiffs = [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1.0] # acetate diff
...
for size in runSizes:
    ...
    for diff in runDiffs:
        ...
        for run in range(numRuns):
            ...
            biofilmSim = Biofilm(sizeDomain=(0.2,0.2),numS1=numStartCells, clusterSize=size, diffDt=diffDt, Adiff=diff)
            biofilmSim.spread()
